...
function simulate( energy = 5000.0, N = 10000; file::String ="Hydrogen", MMM::Int = 1 , dens::Float64 = 3.5e7, temp::Float64 = 75.0)
    ...
    #Varibles for distance calculations:
    varmu = 1.0
    varmunot = 1.0
...
"""
            ...
            tempdist = tempdist + tempvar*varmu
            varmunot = 2*rand()-1
            varmu = varmu*varmunot + sqrt(1-varmu^2)*sqrt(1-varmunot^2)*cos(2*pi*rand()) #Check the formula for 1D isotropic scattering
...
"""
    ...
    print(avgdist/(3.086e16*sqrt(3))) # Direct division by sqrt(3) hoping this will give the 3-D distance
    println(" Pc")
...
@time simulate(5000.0 , 2000, file ="Hydrogen", MMM = 1 , dens = 3.5e7, temp = 1e6)
