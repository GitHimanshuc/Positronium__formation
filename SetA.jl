...
para = [1.0,0.50,16.8,10.0,1.0,10.0,7.0,0.0,10.0,25.0]
...
variation_paral = collect(1:(10-1)/varnum:10)[2:end]   # Variation of the falling rate
variation_parae = collect(1:(20-1)/varnum:20)[2:end]   # Variation of the Excitation threshold
...
savefig("C:\\Users\\Himanshu\\Desktop\\Report\\graphs\\SetA"*name)
