...
variation_parae = collect(6.8:(30-6.8)/varnum:30)[2:end]   # Variation of the Excitation threshold
...
if paranow == arrparaA
    plot(variation_paraA, arrayps,xlabel = " Relative Magnitude of excitation_high cross section",ylabel = "Percentage Positronium formed",label = "With recoil")
    plot!(variation_paraA, arraypsfalse,shape = :circle,label = "Without recoil")
    savefig(dir_path*"SetB/SetB"*name*" ")

    plot(variation_paraA, arrayion,xlabel = " Relative Magnitude of excitation_high cross section",ylabel = "Number of events",label = "excitation_high With recoil")
    ...
    savefig(dir_path*"SetB/SetB"*name*" "*"_collisions")

    plot(variation_paraA, arraythermalization_time,xlabel = " Relative Magnitude of excitation_high cross section",ylabel = "Time (years)",label = "Thermalization time")
    ...
    savefig(dir_path*"SetB/SetB"*name*" "*"_times")
    ...
    savefig(dir_path*"SetB/SetB"*name*" "*"_energy_distribution_on_forming_Ps")
    ...
    savefig(dir_path*"SetB/SetB"*name*" "*"_energy_distribution_below_psthresh")

end

if paranow == arrparal
    plot(variation_paral, arrayps,xlabel = " Parameter lambda of excitation_high cross section",ylabel = "Percentage Positronium formed",label = "With recoil")
    plot!(variation_paral, arraypsfalse,shape = :circle,label = "Without recoil")
    savefig(dir_path*"SetB/SetB"*name*" ")

    plot(variation_paral, arrayion,xlabel = " Parameter lambda of excitation_high cross section",ylabel = "Number of events",label = "excitation_high With recoil")
    ...
    plot(variation_paral, arraythermalization_time,xlabel = " Parameter lambda of excitation_high cross section",ylabel = "Time (years)",label = "Thermalization time")
...
if paranow ==arrparae
    plot(variation_parae, arrayps,xlabel = " excitation_high threshold",ylabel = "Percentage Positronium formed",label = "With recoil")
    plot!(variation_parae, arraypsfalse,shape = :circle,label = "Without recoil")
    savefig(dir_path*"SetB/SetB"*name*" ")

    plot(variation_parae, arrayion,xlabel = " excitation_high threshold",ylabel = "Number of events",label = "excitation_high With recoil")
    ...
    plot(variation_parae, arraythermalization_time,xlabel = " excitation_high threshold",ylabel = "Time (years)",label = "Thermalization time")
